...
class BreakoutN(Breakout):
    ...
    def __init__(self, brick_rows=3, brick_cols=3, trainsessionname='test'):
        ...
        #     Discrete(self.n_ball_x),
        #     Discrete(self.n_ball_y),
        #     Discrete(self.n_ball_dir),
        #     Discrete(self.n_paddle_x)
        # ))
    ...
    def getstate(self):
        ...
        # instead of a single int, return a tuple
        return (ball_x, ball_y, ball_dir, paddle_x)
